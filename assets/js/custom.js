...
$.i18n.ru = {
  ...
  membership_desc: "*Вы можете получить доступ к нашему бесплатному модулю для начинающих прямо сейчас! ",
  ...
  faq_category_2_title_2:
      "Какое оборудование мне нужно для участия в курсе?",
  faq_category_2_desc_2:
  ...
  contact_desc:
      "Хотите получить больше информации? <br/>Мы свяжемся с вами!",
