...
$.i18n.en = {
  ...
  faq_category_1_desc_4:
    "Our course hours have been prepared by taking working individuals into consideration. Our students can access our modules and pre-recorded videos, with a guidance to follow through each week. On Tuesdays and Thursdays, we provide face-to-face support from 10:00 to 16:00 on weekdays, and one-to-one online support is provided to students between 10:00 and 16:00 on Saturdays.",
  ...
  faq_category_2_desc_4:
    "The quota of our robotic coding classes for children is 6-12 people. In our fasttrack course, we do not have a classroom concept as students complete the course at their own pace.",
  ...
  faq_category_3_desc_2:
    "Yes. Our course consists of 5 modules. There will be an assessment at the end of each module. If our student successfully completes all modules, he or she will be offered a job. Our student can accept or reject the offer, but if you refuse, we demand the full fee of our course (8000 TL).",
...
$.i18n.ru = {
  ...
  corp_training_desc: "Совместные учебные пакеты",
  ...
  faq_category_1_desc_4:
    "Наши учебные часы были подготовлены с учетом работающих людей. В связи с этим занятия будут проходить с 18.30 до 21.30 с понедельника по среду, а в субботу с 10.00 до 16.00, студентам будет оказана необходимая поддержкНаши часы курса были подготовлены с учетом работающих людей. В этом контексте наши уроки проходят с помощью записанных видео и нашей обучающей платформы. Мы предоставляем очную поддержку по вторникам и четвергам с 10:00 до 16:00 в будние дни и индивидуальную онлайн-поддержку по субботам с 10:00 до 16:00.Наши часы курса были подготовлены с учетом работающих людей. В этом контексте наши уроки проходят с помощью записанных видео и нашей обучающей платформы. Мы предоставляем очную поддержку по вторникам и четвергам с 10:00 до 16:00 в будние дни и индивидуальную онлайн-поддержку по субботам с 10:00 до 16:00.Наши часы курса были подготовлены с учетом работающих людей. В этом контексте наши уроки проходят с помощью записанных видео и нашей обучающей платформы. Мы предоставляем очную поддержку по вторникам и четвергам с 10:00 до 16:00 в будние дни и индивидуальную онлайн-поддержку по субботам с 10:00 до 16:00.Наши часы курса были подготовлены с учетом работающих людей. В этом контексте наши уроки проходят с помощью записанных видео и нашей обучающей платформы. Мы предоставляем очную поддержку по вторникам и четвергам с 10:00 до 16:00 в будние дни и индивидуальную онлайн-поддержку по субботам с 10:00 до 16:00.Наши часы курса были подготовлены с учетом работающих людей. В этом контексте наши уроки проходят с помощью записанных видео и нашей обучающей платформы. Мы предоставляем очную поддержку по вторникам и четвергам с 10:00 до 16:00 в будние дни и индивидуальную онлайн-поддержку по субботам с 10:00 до 16:00.Наши часы курса были подготовлены с учетом работающих людей. В этом контексте наши уроки проходят с помощью записанных видео и нашей обучающей платформы. Мы предоставляем очную поддержку по вторникам и четвергам с 10:00 до 16:00 в будние дни и индивидуальную онлайн-поддержку по субботам с 10:00 до 16:00.а",
  ...
  faq_category_2_desc_4:
    "Квота наших занятий по робототехнике для детей составляет 6-12 человек. В нашем ускоренном курсе у нас нет концепции классной комнаты, поскольку студенты проходят курс в своем собственном темпе.",
  faq_category_2_title_5:
  ...
  faq_category_3_title_2: "Do you provide job opportunities to your graduates?",
  faq_category_3_desc_2:
    "Да. Наш курс состоит из 5 модулей. В конце каждого модуля будет оценка. Если наш студент успешно завершит все модули, ему будет предложена работа. Наш студент может принять или отклонить предложение, но если вы откажетесь, мы требуем полную стоимость нашего курса (8000 TL).",
  faq_category_3_title_3:
